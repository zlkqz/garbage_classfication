...
<template>
  <div id="DragExample">    
     <div>
        ...
        <span class="addtimetool"><img src="../assets/加时.png"  @click="addtime()" draggable="false" class="picturetool"><span class="addtimenum">{{cnt_addtime}}</span></span>
         <span class="clearalltool" >{{point}}<img src="../assets/清理.png"  @click="allReload()" draggable="false" class="picturetool"><span class="clearallnum">{{cnt_clearall}}</span> </span>
    </div>
        <div v-if="Count_turn" ><img src="../assets/加时.png" class="Picture timeadd" @click="ChangingT()" draggable="false"></div>
        <div v-if="Clear_turn"><img src="../assets/清理.png" class="Picture clearall" @click="ChangingClear()" draggable="false"></div>
     ...
     <VueDragResize class="demo" @dragstop="onActivatedA(order[0])"  @dragging="ChangingA()" :isActive="true" :z="1" :isResizable="false"
     ref="apple" ><img @mouseenter="TouchVideoA()" :src="imgUrl[0]" class="Picture" :style="{opacity:omoA}"> <audio src="../assets/按钮按键-很酷-用户界面-游戏提示音_系统提示音(Cool _爱给网_aigei_com.mp3" id="audioA"></audio> </VueDragResize>
      <VueDragResize class="demo" @dragstop="onActivatedB(order[1])" @dragging="ChangingB()" :isActive="true" :z="1" :isResizable="false"
     ref="banana" ><img @mouseenter="TouchVideoB()" :src="imgUrl[1]" class="Picture" :style="{opacity:omoB}"><audio src="../assets/按钮按键-很酷-用户界面-游戏提示音_系统提示音(Cool _爱给网_aigei_com.mp3" id="audioB"></audio></VueDragResize>
     <VueDragResize class="demo" @dragstop="onActivatedC(order[2])" @dragging="ChangingC()" :isActive="true" :z="1" :isResizable="false"
     ref="cherry" ><img @mouseenter="TouchVideoC()" :src="imgUrl[2]" class="Picture" :style="{opacity:omoC}"><audio src="../assets/按钮按键-很酷-用户界面-游戏提示音_系统提示音(Cool _爱给网_aigei_com.mp3" id="audioC"></audio> </VueDragResize>
      <VueDragResize class="demo" @dragstop="onActivatedD(order[3])" @dragging="ChangingD()" :isActive="true" :z="1" :isResizable="false"
     ref="date" ><img @mouseenter="TouchVideoD()" :src="imgUrl[3]" class="Picture" :style="{opacity:omoD}"><audio src="../assets/按钮按键-很酷-用户界面-游戏提示音_系统提示音(Cool _爱给网_aigei_com.mp3" id="audioD"></audio> </VueDragResize>
      <VueDragResize class="demo" @dragstop="onActivatedE(order[4])" @dragging="ChangingE()" :isActive="true" :z="1" :isResizable="false"
     ref="egg"><img @mouseenter="TouchVideoE()" :src="imgUrl[4]" class="Picture" :style="{opacity:omoE}"> <audio src="../assets/按钮按键-很酷-用户界面-游戏提示音_系统提示音(Cool _爱给网_aigei_com.mp3" id="audioE"></audio></VueDragResize>
    ...
    <div class="TrashCan_R"><img draggable="false" :src="imgUrl_TC_R">  </div>
       <audio id="audio" :src="require('../assets/39辑 - AudioJungel精选合集-快乐的时光(Ha_爱给网_aigei_com.mp3')">
       </audio>
       <audio id="audioT" :src="require('../assets/《天天来塔防》资源素材-Sounds-UI 单板层积材选择(_爱给网_aigei_com.mp3')">
       </audio>
       <audio id="PGaudio" :src="require('../assets/11000游戏常用音效-明亮的提示音_爱给网_aigei_com.mp3')">
       </audio>
       <audio id="audioW" :src="require('../assets/警告-系统警告回答错误-游戏提示_爱给网_aigei_com.mp3')">
       </audio>
       <audio id="addtime" :src="require('../assets/警告-系统警告回答错误-游戏提示_爱给网_aigei_com.mp3')">
       </audio>
       <audio id="clear" :src="require('../assets/UI叮咚音效_爱给网_aigei_com.mp3')"></audio>
  </div>
...
break;
  ...
  break;
  case 12:
   this.imgUrl[cnt]=require('../assets/厨余垃圾-果皮.png');
  break;
   }
  }
   this.cnt_clearall--;
...
this.$refs.egg.top=this.Origin_top[4];
   ...
   if(this.$refs.banana.top<300||this.$refs.banana.left<163)
     ...
     { 
         case 1:
           if(this.$refs.banana.left>=195&&this.$refs.banana.left<=311)
           {
        ...
        this.PositionCreatedB(order);
         ...
         break;
         case 2:
          if(this.$refs.banana.left>=898&&this.$refs.banana.left<=1004)
           {
        ...
        break;
        case 3:
          if(this.$refs.banana.left>=678&&this.$refs.banana.left<=781)
           {
        ...
        break;
        case 0:
          if(this.$refs.banana.left>=444&&this.$refs.banana.left<=554)
           {
   ...
   if(this.$refs.cherry.top<300||this.$refs.cherry.left<163)
     ...
     { 
         case 1:
           if(this.$refs.cherry.left>=195&&this.$refs.cherry.left<=311)
           {
        ...
        this.PositionCreatedC(order);
         ...
         break;
         case 2:
          if(this.$refs.cherry.left>=898&&this.$refs.cherry.left<=1004)
           {
        ...
        break;
        case 3:
          if(this.$refs.cherry.left>=678&&this.$refs.cherry.left<=781)
           {
        ...
        break;
        case 0:
          if(this.$refs.cherry.left>=444&&this.$refs.cherry.left<=554)
           {
    ...
    this.$forceUpdate();
     ...
     PositionCreatedA(order){
      ...
      do{
       ...
       this.Origin_left[order]=Math.ceil(this.Origin_left[0]*500+200*Math.random());
...
break;
  ...
  break;
  case 12:
   this.imgUrl[0]=require('../assets/厨余垃圾-果皮.png');
  break;
   }
   this.PositionCT();
   this.PositionCA();
     ...
     PositionCreatedB(order){
       ...
       do{
       this.Origin_left[order]=Math.random();
       this.Origin_left[order]=Math.ceil(this.Origin_left[1]*200+460*Math.random()+300*Math.random());
       }while(this.Origin_left[order]<=163);
...
break;
  ...
  break;
  case 12:
   this.imgUrl[1]=require('../assets/厨余垃圾-果皮.png');
  break;
   }
   this.PositionCT();
   this.PositionCA();
...
break;
  ...
  break;
  case 12:
   this.imgUrl[2]=require('../assets/厨余垃圾-果皮.png');
  break;
   }
   this.PositionCT();
   this.PositionCA();
...
break;
  ...
  break;
  case 12:
   this.imgUrl[3]=require('../assets/厨余垃圾-果皮.png');
  break;
   }
   this.PositionCT();
   this.PositionCA();
...
this.imgUrl[4]=require('../assets/paper.png');
  ...
  break;
  case 12:
   this.imgUrl[4]=require('../assets/厨余垃圾-果皮.png');
  break;
   }
   this.PositionCT();
   this.PositionCA();
